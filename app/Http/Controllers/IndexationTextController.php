...
class IndexationTextController extends Controller
{
    ...
    public function indexationTEXTEShow(Document $document)
    {
        return view('frontend.show')->with('document',$document);
    }
}
